...
Taking a look at ERR diagram that models the structure of the Mint classics database.

![Extended Entity Relationship diagram](Mint-Classics-Model-Car-Database-with-MySQL-Workbench-Project
/Extended Entity-Relationship diagram.png)
